...
(function () {
  ...
  /* ---------- info ポップ ---------- */
  const INFO = {
    regularity: '睡眠の「規則性」。毎日同じ時刻に寝起きできているかの指標(SRI近似, -100〜100)。大規模研究では規則性は睡眠時間より死亡率を強く予測しました。まずは「最も不規則な層から抜ける」のが目標。',
    debt: '直近14日の「目標−実績」の累積不足。睡眠負債は自覚しにくく、週末の寝だめでは完全には返せません。',
    sjl: '平日と休日の睡眠中央時刻のズレ(ソーシャル時差ぼけ)。大きいほど肥満・抑うつ・代謝リスクと関連。1時間未満が理想。',
    curve: '二プロセスモデル(睡眠圧＋体内時計)による眠気の推定。午後の谷は起床6〜8h後、就床1〜3h前は体内時計の影響で寝つきにくくなります。実測ではなく推定です。',
  };
